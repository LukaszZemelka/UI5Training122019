	...
	function _resetMapListener() {
		...
		aVariantManagementReferences.forEach(function(sVariantManagementReference) {
			...
			_setVariantModelBusy(
				this.oFlexController.revertChangesOnControl.bind(this.oFlexController, mChangesToBeSwitched.changesToBeReverted, this.oAppComponent), this, sVariantManagementReference
			)
				.then(function () {
